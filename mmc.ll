...
entry:
  ...
  br i1 %cmp.not, label %if.end5, label %_Dynamic_check.failed.i
...
if.end5:                                          ; preds = %entry
  %m.173 = load %struct.MapStruct*, %struct.MapStruct** @maps, align 8, !tbaa !2
  %cmp8.not74 = icmp eq %struct.MapStruct* %m.173, null
  br i1 %cmp8.not74, label %if.then21, label %_Dynamic_check.succeeded11

_Dynamic_check.succeeded11:                       ; preds = %if.end5, %_Dynamic_check.succeeded18
  %m.175 = phi %struct.MapStruct* [ %m.1, %_Dynamic_check.succeeded18 ], [ %m.173, %if.end5 ]
  %addr12 = getelementptr inbounds %struct.MapStruct, %struct.MapStruct* %m.175, i64 0, i32 6
...
_Dynamic_check.succeeded18:                       ; preds = %_Dynamic_check.succeeded11
  %next = getelementptr inbounds %struct.MapStruct, %struct.MapStruct* %m.175, i64 0, i32 9
...
if.then21:                                        ; preds = %_Dynamic_check.succeeded18, %if.end5
...
_Dynamic_check.succeeded24:                       ; preds = %_Dynamic_check.succeeded11
  %refcount = getelementptr inbounds %struct.MapStruct, %struct.MapStruct* %m.175, i64 0, i32 4
...
if.end46:                                         ; preds = %_Dynamic_check.succeeded30
  ...
  %reftime = getelementptr inbounds %struct.MapStruct, %struct.MapStruct* %m.175, i64 0, i32 5
...
if.end:                                           ; preds = %entry
  ...
  %cmp4.not76 = icmp eq %struct.MapStruct* %1, null
  br i1 %cmp4.not76, label %if.else30, label %_Dynamic_check.succeeded10.lr.ph
...
_Dynamic_check.succeeded10:                       ; preds = %_Dynamic_check.succeeded10.lr.ph, %_Dynamic_check.succeeded23
  ...
  %mm.077 = phi %struct.MapStruct** [ @maps, %_Dynamic_check.succeeded10.lr.ph ], [ %next, %_Dynamic_check.succeeded23 ]
...
_Dynamic_check.succeeded3.i:                      ; preds = %_Dynamic_check.succeeded14
  ...
  store %struct.MapStruct* %7, %struct.MapStruct** %mm.077, align 8, !tbaa !2
...
entry:
  ...
  %cmp.not8 = icmp eq %struct.MapStruct* %0, null
  br i1 %cmp.not8, label %entry.while.cond1_crit_edge, label %_Dynamic_check.succeeded3.i.lr.ph

entry.while.cond1_crit_edge:                      ; preds = %entry
  %.pre = load %struct.MapStruct*, %struct.MapStruct** @free_maps, align 8, !tbaa !2
  %phi.cmp = icmp eq %struct.MapStruct* %.pre, null
  call void @llvm.assume(i1 %phi.cmp)
  ret void

_Dynamic_check.succeeded3.i.lr.ph:                ; preds = %entry
  %map_count.promoted = load i32, i32* @map_count, align 4, !tbaa !17
  %free_maps.promoted = load %struct.MapStruct*, %struct.MapStruct** @free_maps, align 8, !tbaa !2
  %free_count.promoted = load i32, i32* @free_count, align 4, !tbaa !17
  ...
  %dec.i = add nsw i32 %map_count.promoted, -1
  store %struct.MapStruct* %free_maps.promoted, %struct.MapStruct** %next.i, align 8, !tbaa !2
  %inc.i = add nsw i32 %free_count.promoted, 1
  store i32 %dec.i, i32* @map_count, align 4, !tbaa !17
